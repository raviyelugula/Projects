...
CocaCola_TweetsList= searchTwitter(searchString ='CocaCola+Coke',n=1000 , lang = 'en') 
Pepsi_TweetsList= searchTwitter(searchString ='Pepsi',n=1000 , lang = 'en') 
...
temp = data.frame(word = Terms(CocaCola_Corpus_DTM))
temp = temp %>%
  left_join(get_sentiments('afinn'), by = 'word')
temp$score = ifelse(is.na(temp$score),0,temp$score)
